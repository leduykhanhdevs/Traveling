...
const privacyPolicyHtml = page(
  ...
  `
    ...
    <p>Traveling uses third-party processors to provide core functionality. These services may process data according to their own privacy notices.</p>
    <ul>
    ...
    <p>
      ...
      operate Traveling, comply with legal obligations, enforce our rights, protect users, or complete
    ...
    <h2>Children</h2>
    <p>
      Traveling is not intended for children under 13 or the minimum age required in your jurisdiction.
      We do not knowingly collect personal information from children.
    </p>

    <h2>International Use</h2>
    <p>
      Traveling is designed for international travelers. Your information may be processed in countries
...
const termsHtml = page(
  ...
  `
    ...
    <h2>Third-Party Services</h2>
    <p>
      Traveling integrates with third-party services such as Clerk, Google Places API, OpenAI,
    ...
    <h2>Privacy</h2>
    <p>
      Our Privacy Policy explains how information is collected, used, and shared. By using Traveling,
    ...
    <p>
      ...
      if you violate these Terms, create risk, or use Traveling unlawfully.
    </p>
