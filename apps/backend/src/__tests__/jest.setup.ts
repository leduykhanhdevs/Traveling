const requiredTestEnv: Record<string, string> = {
  ...
  DATABASE_URL: 'postgresql://test:test@localhost:5432/traveling_test',
  DIRECT_URL: 'postgresql://test:test@localhost:5432/traveling_test',
  ...
  SEPAY_WEBHOOK_SECRET: 'test-only-sepay-webhook-secret-32-bytes',
  INVITE_TOKEN_SECRET: 'test-only-invite-token-secret-32-bytes',
  TWILIO_ACCOUNT_SID: 'AC_test_twilio_sid',
