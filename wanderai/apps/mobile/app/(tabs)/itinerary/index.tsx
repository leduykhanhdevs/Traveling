import { CalendarDays, Pencil, Plus, Sparkles, X } from 'lucide-react-native';
...
const buildGeneratedActivity = (dayId: string): TimelineActivity => ({
  ...
  category: 'other',
  aiMatchScore: 93,
  notes: 'WanderAI balances review quality, walking distance, and your pace for this slot.',
...
export default function ItineraryScreen(): JSX.Element {
  ...
  const addActivity = (): void => {
    const title = newPlace.trim() || 'New WanderAI Stop';
    const nextActivity: TimelineActivity = {
      ...
      aiMatchScore: 90,
      notes: 'Added manually. WanderAI can refine this stop once live planning is connected.',
                ...
                <View className="mt-5 gap-4">
                  <GlassCard>
                    <View className="items-start gap-3">
                      ...
                      <Text
                        accessibilityLabel="Let WanderAI build your perfect itinerary"
                        className="font-inter-bold text-2xl text-white"
                      >
                        Let WanderAI build your perfect itinerary
                      </Text>
